...
- A-Trous light rejection uses `V_MC,center/N_eff,center + V_MC,sample/N_eff,sample`, so each tap converts its own MC observation variance into estimator variance before the difference test.
